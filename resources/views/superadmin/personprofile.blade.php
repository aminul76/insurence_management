              ...
              <div class="tab-content">
                ...
                <div id="edit-profile" class="tab-pane">
                  <section class="panel">
                    <div class="panel-body bio-graph-info">
                      <h1> Profile Info</h1>
                      <form class="form-horizontal" role="form" method="POST" action="{{ route('password.update',$customer->id) }}" >
                        @csrf
                        <div class="form-group">
                          <label class="col-lg-2 control-label">Password</label>
                          <div class="col-lg-6">
                            <input type="number" class="form-control" id="f-name" placeholder=" " name="password">
                          </div>
                        </div>
